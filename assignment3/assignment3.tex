...
\begin{document}
	...
	\begin{proof}
		...
		Next, we must show that the set of states reachable in $M'$ by reading $n$ $a$'s from the input is equivalent to the set of states reachable in $M$ by reading any $n$ characters from an input word. This can be shown using induction. It is left as an exercise to the reader.
	\end{proof}
	\section{Exercise 6}
