...
\begin{document}
	...
	\]
	\subsection*{(b) Why is this not only possible $\Alphabet$}
	...
	\subsection*{(a) Is the NEFA model equally expressive as the DFA model?}
	...
	\subsection*{(b) Take 2 DFAs $D_1$ and $D_2$. Now take the language $L=(L(D_1)\cap L(D_2))^*$. Is L regular?}
